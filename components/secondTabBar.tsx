...
import SecondTabButton from './secondTabButton';

function SecondTabBar({ state, descriptors, navigation }: { state: any, descriptors: any, navigation: any }) {
