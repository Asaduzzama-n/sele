...
const SecondTabButton = ({onPress, onLongPress, route, label, isFocused, colors}: {onPress: () => void, onLongPress: () => void, route: any, label: string, isFocused: boolean, colors: any}) => {
...
export default SecondTabButton